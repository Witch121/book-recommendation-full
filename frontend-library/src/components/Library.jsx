...
const { collection, query, where, getDocs, orderBy, updateDoc, doc, deleteDoc } = require('firebase/firestore');
        ...
        <table className="library_table">
          <thead>
            <tr className="showLibraryTableHead">
              {[
                { label: "Title", tooltip: "What’s the title? <br /> Keep it official!" },
                { label: "Author", tooltip: "Who’s the author? <br /> Google if you're stumped!" },
                { label: "Genre", tooltip: "What’s the genre? <br /> Fantasy, romance, mystery… pick one!" },
                { label: "Place", tooltip: "Where’s the book now? <br /> Phone, home, friend’s place?" },
                ...
                { label: "Serie", tooltip: "Is this part of a series? <br /> You’re in for the long haul!" },
                { label: "Keywords", tooltip: "Describe the plot in 3 words. <br /> Challenge accepted?" },
              ].map(({ label, tooltip }) => (
